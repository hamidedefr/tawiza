...
async def lifespan(app: FastAPI):
    ...
    # Shutdown
    logger.info("MPtoO v2 API shutting down...")
    if _ws_manager:
...
app = FastAPI(
    title="MPtoO v2 API",
    description="API for MPtoO Territorial Intelligence Platform with OpenAI-compatible endpoints",
    version="2.0.0",
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc",
...
ALLOWED_ORIGINS = [
    ...
    "https://www.tawiza.fr",
    "https://api.tawiza.fr",
    "https://mptoo-tajine.duckdns.org",
    "http://localhost:3000",
    "http://localhost:3001",
    "http://localhost:3002",
    "http://localhost:3003",
    ...
    "http://127.0.0.1:3005",
    "http://127.0.0.1:3010",
    # Add your internal network IPs here if needed
    # "http://YOUR_IP:3000",
]
...
app.include_router(agents_router)  # MPtoO-specific agent endpoints
...
# Signals V2 API (signals + micro-signals from mptoo DB)
