#!/usr/bin/env bash
# =============================================================================
# MPtoO-V2 Port Checker
# Utilitaire rapide pour verifier l'occupation des ports
# Usage:
#   ./scripts/check-ports.sh --all          # Tous les ports MPtoO
...
# All MPtoO ports with descriptions
declare -A ALL_PORTS=(
...
echo -e "${BOLD}${BLUE}MPtoO-V2 Port Status${NC}"
echo ""
