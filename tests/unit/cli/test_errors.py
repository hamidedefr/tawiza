...
- ErrorInfo dataclass
- MPtoOError exception hierarchy
...
class TestMPtoOError:
    """Test suite for MPtoOError base exception."""
    ...
    def test_creation_with_severity(self):
        """MPtoOError should accept custom severity."""
        error = MPtoOError(
            "Critical failure",
    ...
    def test_creation_with_suggestions(self):
        """MPtoOError should accept suggestions list."""
        error = MPtoOError(
            "Config missing",
...
class TestErrorHandler:
    ...
    def test_handle_mptoo_error(self):
        """Should handle MPtoOError correctly."""
        handler = ErrorHandler()
        error = MPtoOError("Test error", code=ErrorCode.UNKNOWN)
...
class TestExceptionHierarchy:
    ...
    def test_config_errors_inherit_from_mptoo_error(self):
        """Config errors should inherit from MPtoOError."""
        errors = [
            ConfigError("test"),
    ...
    def test_system_errors_inherit_from_mptoo_error(self):
        """System errors should inherit from MPtoOError."""
        errors = [
            SystemError("test"),
            SystemNotInitializedError(),
            SystemAlreadyInitializedError(),
    ...
    def test_network_errors_inherit_from_mptoo_error(self):
        """Network errors should inherit from MPtoOError."""
        errors = [
            NetworkError("test"),
    ...
    def test_gpu_errors_inherit_from_mptoo_error(self):
        """GPU errors should inherit from MPtoOError."""
        error = GPUNotAvailableError()

        assert isinstance(error, GPUError)
        assert isinstance(error, MPtoOError)

    def test_agent_errors_inherit_from_mptoo_error(self):
        """Agent errors should inherit from MPtoOError."""
        error = AgentNotFoundError("agent")

        assert isinstance(error, AgentError)
        assert isinstance(error, MPtoOError)

    def test_file_errors_inherit_from_mptoo_error(self):
        """File errors should inherit from MPtoOError."""
        errors = [
            FileError("test"),
