...
from src.core.exceptions import (
    ...
    ModelLoadError,
    ModelNotFoundError,
    MPtoOConfigurationError,
    # Base
    MPtoOException,
    MPtoOResourceError,
    MPtoOValidationError,
    OllamaServiceError,
    PathTraversalError,
    PythonVersionError,
    # Resources
...
class TestMPtoOException:
    """Test suite for base MPtoOException."""

    def test_basic_creation(self):
        """Should create exception with message."""
        exc = MPtoOException("Something went wrong")
    ...
    def test_creation_with_details(self):
        ...
        exc = MPtoOException("Error", details={"key": "value"})

        assert exc.details["key"] == "value"

    def test_default_details_empty(self):
        """Default details should be empty dict."""
        exc = MPtoOException("Error")

        assert exc.details == {}

    def test_is_exception(self):
        """Should be a valid Exception."""
        exc = MPtoOException("Test")

        assert isinstance(exc, Exception)

    def test_can_be_raised(self):
        """Should be raisable."""
        with pytest.raises(MPtoOException):
            raise MPtoOException("Test error")
...
class TestExceptionHierarchy:
    ...
    def test_config_errors_inherit_from_base(self):
        """Configuration errors should inherit from MPtoOException."""
        errors = [
            MPtoOConfigurationError("test"),
        ...
        for exc in errors:
            assert isinstance(exc, MPtoOException)

    def test_resource_errors_inherit_from_base(self):
        """Resource errors should inherit from MPtoOException."""
        errors = [
            MPtoOResourceError("test"),
    ...
    def test_agent_errors_inherit_from_base(self):
        """Agent errors should inherit from MPtoOException."""
        errors = [
            AgentError("test"),
    ...
    def test_security_errors_inherit_from_base(self):
        """Security errors should inherit from MPtoOException."""
        errors = [
            SecurityError("test"),
