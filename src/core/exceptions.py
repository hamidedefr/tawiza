"""Custom exceptions for MPtoO-V2.
...
class MPtoOException(Exception):
    """Base exception for all MPtoO-V2 errors."""
...
class MPtoOConfigurationError(MPtoOException):
    """Configuration-related errors."""
    pass


class MPtoOResourceError(MPtoOException):
    """Resource availability or access errors."""
    pass


class MPtoOValidationError(MPtoOException):
    """Validation errors."""
    pass
...
class SystemNotInitializedError(MPtoOException):
...
class SystemAlreadyInitializedError(MPtoOException):
...
class SystemInitializationError(MPtoOException):
...
class SystemRequirementError(MPtoOException):
...
class ConfigurationNotFoundError(MPtoOConfigurationError):
...
class ConfigurationCorruptedError(MPtoOConfigurationError):
...
class InvalidConfigurationError(MPtoOConfigurationError):
...
class AgentError(MPtoOException):
...
class TaskError(MPtoOException):
...
class ResourceExhaustedError(MPtoOResourceError):
...
class SecurityError(MPtoOException):
...
class DebugError(MPtoOException):
...
class DebuggerNotStartedError(DebugError):
    ...
    def __init__(self):
        super().__init__("Debugger not started. Use 'mptoo debug start' first.")
...
class ExternalServiceError(MPtoOException):
...
class ModelError(MPtoOException):
