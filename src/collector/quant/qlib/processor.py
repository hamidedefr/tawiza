...
class FillnaProcessor(Processor):
    ...
    def __init__(self, fill_value: float | int = 0,
                 method: str = 'value',
...
class PopulationNormalizer(Processor):
    ...
    def __init__(self, population_data: pd.DataFrame | dict,
                 per_n: int = 10000,
                 fields: list[str] | None = None):
...
def create_standard_chain(population_data: pd.DataFrame | dict | None = None,
