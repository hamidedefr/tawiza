#!/usr/bin/env python3
"""
Utilitaires UI pour MPtoO-V2 CLI
...
def show_sunset_header():
    ...
    header_text.append("MPtoO-V2 Advanced AI Agents System", style=f"bold {SUNSET_THEME['header_color']}")
    header_text.append(" 🤖", style=SUNSET_THEME["header_color"])
...
def show_sunset_footer():
    ...
    footer_text.append("MPtoO-V2 ", style=f"bold {SUNSET_THEME['header_color']}")
