...
class MatrixRain:
    ...
    def __init__(self, width: int = 80, height: int = 40):
        ...
        self.chars = "ｱｲｳｴｵｶｷHamide la Mitteｻｼｽｾｿﾀﾁﾂﾃﾄﾅﾆﾇﾈﾉﾊﾋﾌﾍﾎﾏﾐﾑﾒﾓﾔﾕﾖﾗﾘﾙﾚﾛﾜｦﾝ0123456789"
...
"""
    ...
    @classmethod
    def get_banner(cls, style: str = "mptoo") -> str:
        """
        Get banner by style

        Args:
            style: Banner style (mptoo, cyberpunk, minimal)

        Returns:
            Banner ASCII art
        """
        banners = {
            "mptoo": cls.MPTOO_BANNER,
            "cyberpunk": cls.CYBERPUNK_BANNER,
            "minimal": cls.MINIMAL_BANNER,
        }

        return banners.get(style.lower(), cls.MPTOO_BANNER)
