...
class DatabaseSettings(BaseSettings):
    ...
    url: PostgresDsn = Field(
        default="postgresql+asyncpg://mptoo:password@localhost:5432/mptoo",
...
class MLflowSettings(BaseSettings):
    ...
    experiment_name: str = Field(default="mptoo-training")
...
class MinIOSettings(BaseSettings):
    ...
    bucket: str = Field(default="mptoo-models")
...
class Settings(BaseSettings):
    ...
    # Application
    app_name: str = Field(default="MPtoO")
