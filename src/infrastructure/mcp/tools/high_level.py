"""High-level MCP tools for MPtoO.

These tools provide simple, powerful interfaces for common tasks:
- mptoo/analyze: Complete market analysis
- mptoo/search: Multi-source search
- mptoo/validate: Multi-agent debate validation
- mptoo/map: Generate interactive map
- mptoo/chat: Conversational assistant
...
"""
    ...
    @mcp.tool()
    async def mptoo_chat(
        message: str,
        mode: Literal["assistant", "analyst", "data"] = "assistant",
        context: str | None = None,
        ctx: Context = None,
    ) -> str:
        """Assistant conversationnel MPtoO.
