...
"""
        ...
        report_md += f"""
---
*Simulation generee par MPtoO (confiance: {confidence}%)*
...
"""
    ...
    @mcp.tool()
    async def mptoo_scenarios_list(ctx: Context = None) -> str:
        ...
        return json.dumps({
            ...
            "usage": "mptoo_simulate(scenario='<id>', territory='<ville>', sector='<secteur>')",
        }, ensure_ascii=False, indent=2)

    @mcp.tool()
    async def mptoo_impact_analysis(
        territory: str,
        sector: str,
