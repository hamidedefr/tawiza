...
class APIClient:
    ...
    def __init__(self, base_url: str | None = None, timeout: float = 30.0):
        ...
        """
        self.base_url = base_url or os.getenv("MPTOO_API_URL", "http://localhost:8000")
    ...
    def _handle_connection_error(self, e: Exception, endpoint: str):
        ...
        console.print(Panel(
            ...
            f"  1. Démarrer le backend: [green]mptoo system start[/green]\n"
            f"  2. Vérifier le statut: [green]mptoo system status[/green]\n"
            f"  3. Définir une URL personnalisée: [dim]export MPTOO_API_URL=http://...[/dim]",
    ...
    def _handle_404_error(self, endpoint: str):
        ...
        console.print(Panel(
            ...
            f"  • [dim]mptoo models list[/dim] - Modèles Ollama\n"
            f"  • [dim]mptoo system status[/dim] - Statut système\n"
            f"  • [dim]mptoo finetune list[/dim] - Jobs de fine-tuning",
