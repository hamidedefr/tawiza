"""Camel AI Tools for MPtoO territorial intelligence.

Provides FunctionTool wrappers for existing MPtoO capabilities:
...
def get_all_tools() -> list[FunctionTool]:
    """Get all MPtoO tools as Camel FunctionTools.
