    ...
    async def mptoo_generate_bp(
        ...
        Args:
            ...
            market_data: Données de marché (JSON ou texte) - optionnel, peut être
                        récupéré automatiquement via mptoo_workforce_analyze
...
### Sources de données
- Analyse territoriale MPtoO
- Base SIRENE (INSEE)
- Données sectorielles

---

*Business Plan généré par MPtoO - Intelligence Territoriale*
...
"""
    ...
    @mcp.tool()
    async def mptoo_bp_templates(ctx: Context = None) -> str:
        ...
        return json.dumps({
            ...
            "usage": "mptoo_generate_bp(company_name='...', company_description='...', territory='...', sector='tech')",
        }, ensure_ascii=False, indent=2)

    @mcp.tool()
    async def mptoo_bp_section(
        section: str,
        company_context: str,
        market_context: str = "",
        sector: str = "tech",
    ...
    @mcp.tool()
    async def mptoo_bp_from_analysis(
        analysis_dir: str,
        company_name: str,
        company_description: str,
        sector: str = "tech",
        ...
        """Génère un business plan à partir d'une analyse MPtoO existante.
        ...
        result = await mptoo_generate_bp(
