"""Unified agent executor for MPtoO CLI v2.
...
class AgentExecutor:
    """Unified executor for all MPtoO agents."""
        ...
        **kwargs
        ...
        if not data:
            return {
                ...
                "usage": "mptoo run analyst -t 'analyze' -d data.csv"
            }
        ...
        **kwargs
        ...
        if not data:
            return {
                ...
                "usage": "mptoo run ml -t 'train classification model' -d data.csv"
            }
