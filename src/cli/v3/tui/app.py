"""MPtoO TUI v6 - Main Application with ContentSwitcher Layout.
...
class MPtoOApp(App):
    """MPtoO Terminal User Interface v6 - With WebSocket Integration."""
    ...
    def _load_theme_preference(self) -> None:
        ...
        """
        import json
        prefs_file = Path("/root/MPtoO-V2/.tui_preferences.json")
        try:
    ...
    def action_show_help(self) -> None:
        ...
        help_text = """
[bold cyan]MPtoO TUI v6[/bold cyan]
