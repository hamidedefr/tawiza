...
class TestRegisterExceptionHandlers:
    ...
    def test_mptoo_error_handler(self):
        """MPtoOError should be handled with appropriate status code."""
    ...
    def test_general_exception_handler(self):
        ...
        data = response.json()
        assert data["success"] is False
        assert data["error"]["code"] == "MPTOO-INF-000"
...
class TestRequestValidationErrorHandling:
    ...
    def test_validation_error_returns_422(self):
        ...
        data = response.json()
        assert data["success"] is False
        assert data["error"]["code"] == "MPTOO-API-001"
...
class TestHTTPExceptionHandling:
    ...
    def test_http_exception_returns_correct_status(self):
        ...
        assert data["error"]["code"] == "MPTOO-API-403"
