...
This module defines all domain-specific exceptions for MPtoO-V2.
...
Error Code Format: MPTOO-{CATEGORY}-{NUMBER}
- MPTOO-DOM-xxx: Domain errors
- MPTOO-APP-xxx: Application/use case errors
- MPTOO-INF-xxx: Infrastructure errors
- MPTOO-API-xxx: API/interface errors
"""

from typing import Any


class MPtoOError(Exception):
    """Base exception for all MPtoO errors.
...
# =============================================================================
# Domain Errors (MPTOO-DOM-xxx)
# =============================================================================


class DomainError(MPtoOError):
...
# =============================================================================
# Application Errors (MPTOO-APP-xxx)
# =============================================================================


class ApplicationError(MPtoOError):
...
# =============================================================================
# Infrastructure Errors (MPTOO-INF-xxx)
# =============================================================================


class InfrastructureError(MPtoOError):
...
# =============================================================================
# ML/Agent Errors (MPTOO-ML-xxx)
# =============================================================================


class MLError(MPtoOError):
...
# =============================================================================
# API Errors (MPTOO-API-xxx)
# =============================================================================


class APIError(MPtoOError):
...
def error_to_response(error: MPtoOError) -> dict[str, Any]:
...
def wrap_error(
    ...
    """Wrap a generic exception into an MPtoO error.

    Args:
        exception: Original exception
        error_class: MPtoO error class to use
