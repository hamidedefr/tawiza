#compdef mptoo
# MPtoO CLI zsh completion
# Install: Copy to ~/.zsh/completions/_mptoo or /usr/local/share/zsh/site-functions/_mptoo
...
_mptoo() {
    ...
    case $state in
        command)
            _describe -t commands 'mptoo commands' commands
            ;;
        args)
            case $words[1] in
                pro)
