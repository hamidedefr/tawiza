...
def analyze_command(
    ...
    Examples:
        mptoo tajine analyze "Analyse tech sector in 34"
        mptoo tajine analyze "Compare enterprises in 75 vs 13" --verbose
        mptoo tajine analyze "Prospect biotech in Occitanie" --real-api
        mptoo tajine analyze --territory 34 --sector tech
    """
    if not query and not territory:
        console.print("[yellow]Provide a query or use --territory[/]")
        console.print("[dim]Example: mptoo tajine analyze \"Analyse tech sector in 34\"[/]")
        return
