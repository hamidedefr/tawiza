#!/usr/bin/env python3
"""
LangfuseAgentTracer - Tracing et observabilité des agents MPtoO via Langfuse
...
class LangfuseAgentTracer:
    """Tracer Langfuse pour les agents MPtoO - Compatible SDK v2"""
    ...
    def __init__(
        ...
        self.release = release or os.getenv("LANGFUSE_RELEASE", "mptoo-v2")
        self.debug = debug
