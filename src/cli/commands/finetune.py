...
def start(
    ...
    Example:
        mptoo finetune start --project 1 --model qwen3-coder:30b --name my-model
        mptoo finetune start -p 1 -m qwen3.5:27b -n custom-classifier -a data.json
    """
    ...
    try:
        ...
        if watch_progress:
            ...
            console.print(f"\n[cyan]💡 Use [bold]mptoo finetune watch {job_data['job_id']}[/bold] to monitor progress[/cyan]")
...
def list(
    ...
    Example:
        mptoo finetune list
        mptoo finetune list --limit 20 --status running
    """
...
def watch(
    ...
    Example:
        mptoo finetune watch abc-123
        mptoo finetune watch abc-123 --interval 5
    """
...
def models(
    ...
    Example:
        mptoo finetune models
        mptoo finetune models --limit 50
    """
