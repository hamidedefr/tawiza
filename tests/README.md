...
Suite complète de tests d'intégration pour le pipeline ML MPtoO-V2.
...
# Database (optional)
DATABASE_URL=postgresql+asyncpg://mptoo:password@localhost:5432/mptoo_test
