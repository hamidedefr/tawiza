...
class ConfigScreen(Container):
    ...
    def _load_tui_preferences(self) -> dict[str, Any]:
        ...
        prefs_path = Path("/root/MPtoO-V2/.tui_preferences.json")
    ...
    def _load_config(self) -> None:
        ...
        env_path = Path("/root/MPtoO-V2/.env")
        env_vars = {}
        ...
        self._config = {
            # Application
            "app_name": env_vars.get("APP_NAME", "MPtoO"),
    ...
    def compose(self) -> ComposeResult:
        ...
        with Horizontal(id="config-header"):
            yield Static("[bold cyan]CONFIG[/] - MPtoO Application Settings")
    ...
    def _apply_theme_for_next_launch(self, theme: str) -> None:
        ...
        try:
            ...
            styles_dir = Path("/root/MPtoO-V2/src/cli/v3/tui/styles")
