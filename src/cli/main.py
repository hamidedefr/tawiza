#!/usr/bin/env python3
"""
MPtoO-V2 CLI Principale avec intégration complète des agents et debugging
...
def main(
    ...
    """MPtoO-V2 - Système Multi-Agents IA Avancé avec Optimisation GPU"""
...
def quickstart(
    ...
    try:
        ...
        if gpu:
            console.print(f"  🎮 {THEME_DICT['accent_color']}mptoo agents gpu-optimize --model qwen3.5:27b --benchmark[/]{THEME_DICT['text_color']}")
            console.print("     Optimiser les performances GPU")
            console.print()

        console.print(f"  📊 {THEME_DICT['accent_color']}mptoo agents analyze-data data/dataset.csv[/]{THEME_DICT['text_color']}")
        console.print("     Analyser un dataset")
        console.print()

        console.print(f"  💻 {THEME_DICT['accent_color']}mptoo agents generate-code 'Créer une API REST' --language python --framework fastapi[/]{THEME_DICT['text_color']}")
        console.print("     Générer du code")
        console.print()

        if monitoring:
            console.print(f"  🐛 {THEME_DICT['accent_color']}mptoo debug monitor --realtime --duration 60[/]{THEME_DICT['text_color']}")
            console.print("     Monitorer en temps réel")
            console.print()

        console.print(f"  📚 {THEME_DICT['accent_color']}mptoo --help[/]{THEME_DICT['text_color']}")
        ...
        if interactive:
            ...
            console.print()
            console.print(f"[bold {THEME_DICT['info_color']}]💡 Astuce: Utilisez 'mptoo quickstart --interactive' pour un guide guidé[/bold {THEME_DICT['info_color']}]")
        else:
        ...
        console.print(f"[bold {THEME_DICT['info_color']}]💡 Utilisez 'mptoo system status' pour diagnostiquer le problème[/bold {THEME_DICT['info_color']}]")
        raise typer.Exit(1)
...
def demo(
    ...
    console.print(f"[bold {THEME_DICT['info_color']}]🎮 Démonstration interactive de MPtoO-V2[/bold {THEME_DICT['info_color']}]")
    console.print()
...
def wizard():
    ...
    console.print(f"[bold {THEME_DICT['info_color']}]🧙 Assistant de configuration MPtoO-V2[/bold {THEME_DICT['info_color']}]")
    console.print()

    try:
        # Étape 1: Présentation
        console.print(f"[bold {THEME_DICT['accent_color']}]Bienvenue dans l'assistant MPtoO-V2![/bold {THEME_DICT['accent_color']}]")
        console.print()
        ...
        if gpu_enabled:
            console.print(f"  🎮 {THEME_DICT['accent_color']}mptoo agents gpu-optimize --model qwen3.5:27b[/]{THEME_DICT['text_color']}")
            console.print("     Optimiser les performances GPU")
            console.print()
        ...
        console.print()
        console.print(f"[bold {THEME_DICT['info_color']}]💡 Vous pouvez maintenant utiliser toutes les commandes MPtoO-V2![/bold {THEME_DICT['info_color']}]")

    except Exception as e:
        console.print(f"\n[bold {THEME_DICT['error_color']}]❌ Erreur dans l'assistant: {e}[/bold {THEME_DICT['error_color']}]")
        console.print(f"[bold {THEME_DICT['info_color']}]💡 Réessayez ou utilisez 'mptoo system status' pour diagnostiquer[/bold {THEME_DICT['info_color']}]")
        raise typer.Exit(1)
...
def show_version():
    ...
    try:
        ...
        version_text = Text()
        version_text.append("MPtoO-V2 ", style=f"bold {THEME_DICT['header_color']}")
