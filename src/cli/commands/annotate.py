...
def handle_api_error(e: Exception, action: str = "operation"):
    ...
    if isinstance(e, httpx.ConnectError):
        console.print(Panel(
            ...
            "[cyan]Solutions:[/cyan]\n"
            "  1. Démarrer le backend: [green]mptoo system start[/green]\n"
...
def create(
    ...
    Example:
        mptoo annotate create --name "Product Reviews" --desc "Classify product sentiment" --type classification
        mptoo annotate create -n "Named Entities" -d "Extract entities" -t ner
    """
...
def export(
    ...
    Example:
        mptoo annotate export 1
        mptoo annotate export 1 --output annotations.json
        mptoo annotate export 1 -o data.csv -f csv
    """
...
def upload(
    ...
    Example:
        mptoo annotate upload 1 --file tasks.json
        mptoo annotate upload 1 -f data.json
    """
...
def delete(
    ...
    Example:
        mptoo annotate delete 1
        mptoo annotate delete 1 --yes
    """
    if not confirm:
