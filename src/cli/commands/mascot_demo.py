"""
Démo des animations de mascotte MPtoO.
...
def demo_all():
    ...
    console.print()
    console.print(Panel(
        "[bold magenta]Démonstration des Animations Mascotte MPtoO[/bold magenta]",
...
def show_help():
    ...
    console.print("[dim]Lancez 'mptoo mascot-demo all' pour voir toutes les animations[/dim]")
