.PHONY: help install dev test lint format clean docker-up docker-down migrate \
       ...
       dashboard dashboard-stop dashboard-status dashboard-url
...
# Default target
help:
	@echo "MPtoO Development Commands"
	@echo "=========================="
	@echo ""
	@echo "Setup:"
	...
	@echo ""
	@echo "Tailscale Dashboard:"
	@echo "  make dashboard      Start MPtoO dashboard via Tailscale"
	@echo "  make dashboard-stop Stop the Tailscale dashboard"
	@echo "  make dashboard-status Show dashboard status"
	@echo "  make dashboard-url  Print the Tailscale HTTPS URL"
	@echo ""
	@echo "DevOps:"
	@echo "  make preflight      Pre-start verification (ports, prereqs, config)"
	@echo "  make check-ports    Show status of all MPtoO ports"
...
dev-start: preflight docker-up
	@echo ""
	@echo "==========================================="
	@echo " MPtoO-V2 Infrastructure Started"
	@echo "==========================================="
	@echo ""
...
dev-stop:
	...
	@echo ""
	@echo "Checking for local processes on MPtoO ports..."
...
# Start dashboard via Tailscale
dashboard:
	@./scripts/tailscale-dashboard.sh start

# Stop dashboard
dashboard-stop:
	@./scripts/tailscale-dashboard.sh stop

# Dashboard status
dashboard-status:
	@./scripts/tailscale-dashboard.sh status

# Print Tailscale dashboard URL
dashboard-url:
	@./scripts/tailscale-dashboard.sh url
