...
class ResponseGenerator:
    ...
    def __init__(self,
        ...
        self.templates = {
            "greeting": [
                "Hello! I'm the MPtoO AI assistant. How can I help you today?",
                "Hi there! I'm here to help you with fine-tuning, training, and model management. What would you like to do?",
                "Welcome! I can assist you with the MPtoO platform. What brings you here?"
            ],
            "farewell": [
        ...
        self.system_prompts = {
            "general": """You are the MPtoO AI Assistant, a helpful and knowledgeable assistant for the MPtoO platform.

MPtoO is a comprehensive AI/ML operations platform that provides:
...
If you don't know something, say so and suggest alternatives.""",
            ...
            "technical": """You are a technical expert assistant for the MPtoO platform.
...
Use technical language appropriately and provide code examples when relevant.""",
            ...
            "beginner": """You are a friendly, patient tutor for the MPtoO platform.

Help beginners understand:
- Basic concepts of fine-tuning and LLMs
- How to get started with MPtoO
...
**Model Management:**
- List available models: `mptoo models list`
- Show model details: `mptoo models show <model-name>`
- Pull models: `mptoo models pull <model-name>`

**Fine-tuning:**
- Start fine-tuning: `mptoo finetune start --config <config-file>`
- Check status: `mptoo finetune status <job-id>`
- List jobs: `mptoo finetune list`

**Prompts:**
- List prompts: `mptoo prompts list`
- Test prompt: `mptoo prompts test <prompt-id>`

**System:**
- System status: `mptoo system status`
- View logs: `mptoo system logs`
...
"""
    ...
    def generate_capabilities_summary(self) -> str:
        ...
        return """🤖 MPtoO AI Assistant Capabilities
...
Just ask me anything about the MPtoO platform!
"""
