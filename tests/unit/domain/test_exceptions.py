...
- Base MPtoOError and its subclasses
- Error code formats
- HTTP status codes
...
class TestMPtoOError:
    """Tests for base MPtoOError."""

    def test_basic_creation(self):
        """MPtoOError should be created with message."""
        error = MPtoOError("Something went wrong")

        assert error.message == "Something went wrong"
        assert error.code == "MPTOO-000-000"
        assert error.http_status == 500
        assert error.details == {}

    def test_creation_with_custom_code(self):
        """MPtoOError should accept custom error code."""
        error = MPtoOError("Error", code="CUSTOM-001")

        assert error.code == "CUSTOM-001"

    def test_creation_with_details(self):
        """MPtoOError should accept details dictionary."""
        error = MPtoOError("Error", details={"key": "value", "count": 42})

        assert error.details["key"] == "value"
        assert error.details["count"] == 42

    def test_to_dict(self):
        """MPtoOError should convert to dictionary."""
        error = MPtoOError("Test error", code="TEST-001", details={"field": "name"})
    ...
    def test_str_representation(self):
        """MPtoOError should have readable string representation."""
        error = MPtoOError("Something failed", code="ERR-123")

        assert str(error) == "[ERR-123] Something failed"

    def test_is_exception(self):
        """MPtoOError should be a valid Exception."""
        error = MPtoOError("Test")

        assert isinstance(error, Exception)
        with pytest.raises(MPtoOError):
            raise error
...
class TestDomainErrors:
    ...
    def test_domain_error_base(self):
        ...
        assert error.code == "MPTOO-DOM-000"
    ...
    def test_entity_not_found_error(self):
        ...
        assert error.code == "MPTOO-DOM-001"
    ...
    def test_entity_already_exists_error(self):
        ...
        assert error.code == "MPTOO-DOM-002"
    ...
    def test_validation_error(self):
        ...
        assert error.code == "MPTOO-DOM-003"
    ...
    def test_invalid_state_error(self):
        ...
        assert error.code == "MPTOO-DOM-004"
        assert error.http_status == 409
    ...
    def test_business_rule_violation_error(self):
        ...
        assert error.code == "MPTOO-DOM-005"
...
class TestApplicationErrors:
    ...
    def test_application_error_base(self):
        ...
        assert error.code == "MPTOO-APP-000"
        assert error.http_status == 500
    ...
    def test_use_case_error(self):
        ...
        assert error.code == "MPTOO-APP-001"
        assert error.http_status == 500
    ...
    def test_authentication_error(self):
        ...
        assert error.code == "MPTOO-APP-002"
    ...
    def test_authorization_error(self):
        ...
        assert error.code == "MPTOO-APP-003"
    ...
    def test_rate_limit_error(self):
        ...
        assert error.code == "MPTOO-APP-004"
...
class TestInfrastructureErrors:
    ...
    def test_infrastructure_error_base(self):
        ...
        assert error.code == "MPTOO-INF-000"
    ...
    def test_database_error(self):
        ...
        assert error.code == "MPTOO-INF-001"
        assert error.http_status == 503
    ...
    def test_external_service_error(self):
        ...
        assert error.code == "MPTOO-INF-002"
    ...
    def test_connection_error(self):
        ...
        assert error.code == "MPTOO-INF-003"
        assert error.http_status == 503
    ...
    def test_timeout_error(self):
        ...
        assert error.code == "MPTOO-INF-004"
    ...
    def test_configuration_error(self):
        ...
        assert error.code == "MPTOO-INF-005"
        assert error.http_status == 500
...
class TestMLErrors:
    ...
    def test_ml_error_base(self):
        ...
        assert error.code == "MPTOO-ML-000"
        assert error.http_status == 500
    ...
    def test_model_not_found_error(self):
        ...
        assert error.code == "MPTOO-ML-001"
        assert error.http_status == 404
    ...
    def test_model_load_error(self):
        ...
        assert error.code == "MPTOO-ML-002"
        assert error.http_status == 503
    ...
    def test_inference_error(self):
        ...
        assert error.code == "MPTOO-ML-003"
        assert error.http_status == 500
    ...
    def test_training_error(self):
        ...
        assert error.code == "MPTOO-ML-004"
        assert error.http_status == 500
    ...
    def test_agent_error(self):
        ...
        assert error.code == "MPTOO-ML-005"
        assert error.http_status == 500
    ...
    def test_agent_timeout_error(self):
        ...
        assert error.code == "MPTOO-ML-006"
        assert error.http_status == 504
...
class TestAPIErrors:
    ...
    def test_api_error_base(self):
        ...
        assert error.code == "MPTOO-API-000"
        assert error.http_status == 400
    ...
    def test_bad_request_error(self):
        ...
        assert error.code == "MPTOO-API-001"
        assert error.http_status == 400
    ...
    def test_not_found_error(self):
        ...
        assert error.code == "MPTOO-API-002"
        assert error.http_status == 404
    ...
    def test_method_not_allowed_error(self):
        ...
        assert error.code == "MPTOO-API-003"
...
class TestUtilityFunctions:
    ...
    def test_error_to_response(self):
        ...
        assert response["error"]["code"] == "MPTOO-DOM-001"
    ...
    def test_wrap_error_custom_class(self):
        ...
        assert wrapped.code == "MPTOO-INF-001"
...
class TestErrorHierarchy:
    ...
    def test_domain_error_is_mptoo_error(self):
        """DomainError should inherit from MPtoOError."""
        error = DomainError("Test")

        assert isinstance(error, MPtoOError)
        assert isinstance(error, Exception)
    ...
    def test_infrastructure_error_is_mptoo_error(self):
        """InfrastructureError should inherit from MPtoOError."""
        error = InfrastructureError("Test")

        assert isinstance(error, MPtoOError)

    def test_ml_error_is_mptoo_error(self):
        """MLError should inherit from MPtoOError."""
        error = MLError("Test")
...
class TestExceptionRaising:
    ...
    def test_catch_base_error(self):
        """All errors should be catchable by MPtoOError."""
        errors = [
