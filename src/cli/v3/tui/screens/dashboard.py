    ...
    async def _update_services(self) -> None:
        ...
        try:
            async with httpx.AsyncClient(timeout=2.0) as client:
                ...
                services["MPtoO API"] = "online" if response.status_code == 200 else "error"
        except Exception:
            services["MPtoO API"] = "offline"
        ...
        try:
            ...
            import redis
            redis_password = os.environ.get("REDIS_PASSWORD", "W7fJZ2dA8lq3iCRj78NQTmzAdmj3k9R2b2mRjQtjd1I=")
    ...
    async def _connect_websocket(self) -> None:
        ...
        try:
            ...
            if await client.connect():
                activity = self.query_one("#activity-panel", ActivityLog)
                activity.add_entry("[green]Connected to MPtoO API[/]")
