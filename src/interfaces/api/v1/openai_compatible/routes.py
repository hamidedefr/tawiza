...
async def chat_completions(
    ...
    This endpoint supports both MPtoO agents (models starting with "mptoo-")
    and standard Ollama models.

    **Example with MPtoO agent:**
    ```json
    {
        "model": "mptoo-analyst",
        "messages": [
...
async def list_models(current_user: AuthUser = Depends(get_current_user)):
    ...
    Returns both MPtoO agents and Ollama models in OpenAI-compatible format.
...
async def health_check():
    ...
    try:
        ...
        return {
            ...
            "mptoo_agents": list(orchestrator.mptoo_agents.keys()),
        }
