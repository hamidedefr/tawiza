...
MASCOT_STATE_FILE = Path.home() / ".mptoo" / ".mascot_state"

# Tips aléatoires
TIPS = [
    ("mptoo models list", "Voir tous les modèles Ollama disponibles"),
    ("mptoo system status", "Vérifier l'état du système"),
    ("mptoo chat", "Discuter avec l'assistant IA"),
    ("mptoo finetune list", "Voir les jobs de fine-tuning"),
    ("mptoo mascot --gallery", "Voir toutes les mascottes!"),
    ("mptoo completion install", "Activer l'autocomplétion"),
    ("mptoo live gpu-check", "Vérifier l'état du GPU"),
    ("mptoo debug status", "Voir le statut de débogage"),
    ("mptoo quickstart", "Démarrage rapide guidé"),
    ("mptoo wizard", "Assistant de configuration"),
]
...
ERROR_HELP = [
    ...
    "Essaie 'mptoo debug status' pour plus d'infos",
