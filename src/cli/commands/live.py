...
def openmanus(
    ...
    Examples:
        mptoo live openmanus "Find cheapest iPhone on Amazon" --url https://amazon.com
        mptoo live openmanus "Extract top 10 HackerNews articles"
        mptoo live openmanus "Navigate to GitHub" --url https://github.com --headed
        mptoo live openmanus "Solve captcha" --vnc  # View via VNC at :5900
    """
...
def skyvern(
    ...
    Examples:
        mptoo live skyvern "Book a hotel in Paris" --url https://booking.com
        mptoo live skyvern "Fill contact form" --url https://example.com/contact
        mptoo live skyvern "Solve captcha manually" --vnc
    """
...
def stream_test(
    ...
    Example:
        mptoo live stream-test "Explain Playwright vs Selenium"
    """
...
def vnc_setup(
    ...
    Examples:
        mptoo live vnc-setup           # Show setup instructions
        mptoo live vnc-setup --start   # Setup and start VNC server
    """
    import os
    import subprocess

    console.print(Panel(
        "[bold cyan]🖥️ Configuration VNC pour MPtoO Browser Automation[/bold cyan]",
        border_style="cyan"
    ))
    ...
    if start:
        ...
        console.print(Panel(
            ...
            "  mptoo live openmanus 'task' --headed\n"
            "  mptoo live skyvern 'task' --headed",
            title="📺 VNC Actif",
            border_style="green"
        ))
    else:
        console.print(Panel(
            ...
            f"[green]mptoo live openmanus 'task' --headed[/green]\n\n"
            f"[cyan]Ou utilisez: mptoo live vnc-setup --start[/cyan]",
            title="📖 Setup Manuel",
            border_style="cyan"
        ))
