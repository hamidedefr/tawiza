...
def install(
    ...
    """
    🚀 Install shell completion for MPtoO CLI.

    Auto-detects your shell if not specified.

    Examples:
        mptoo completion install
        mptoo completion install --shell bash
        mptoo completion install --shell zsh
    """
    # Header
    ...
    try:
        ...
        result = subprocess.run(
            ["mptoo", "--install-completion", shell],
            capture_output=True,
            text=True
        )
...
def show(
    ...
    Examples:
        mptoo completion show
        mptoo completion show --shell bash
    """
    if not shell:
        shell = detect_shell()
...
def status():
    ...
    # Installation tip
    console.print("[dim]💡 Tip: Run [bold]mptoo completion install[/bold] to enable tab completion[/dim]\n")
...
[bold cyan]Quick Installation:[/bold cyan]
    ...
    [green]mptoo completion install[/green]

[bold cyan]Features:[/bold cyan]

  • Auto-complete commands: [dim]mptoo mo<TAB> → models[/dim]
  • Auto-complete options: [dim]mptoo models --<TAB> → --help, --format, etc.[/dim]
