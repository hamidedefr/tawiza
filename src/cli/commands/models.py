#!/usr/bin/env python3
"""
Commandes de gestion des modèles pour MPtoO-V2
...
app = typer.Typer(
    name="models",
    help="Gestion des modèles ML/LLM pour MPtoO-V2",
...
def install_model(
    ...
    try:
        ...
        console.print(f"  🎯 {SUNSET_THEME['accent_color']}mptoo models test {model}[/]{SUNSET_THEME['text_color']} - Tester le modèle")
        console.print(f"  🎮 {SUNSET_THEME['accent_color']}mptoo agents gpu-optimize --model {model}[/]{SUNSET_THEME['text_color']} - Optimiser les performances")
        console.print(f"  📊 {SUNSET_THEME['accent_color']}mptoo models info {model}[/]{SUNSET_THEME['text_color']} - Voir les détails")
...
def test_model(
    ...
    if model not in installed_models:
        ...
        console.print(f"Installez-le d'abord avec: mptoo models install {model}")
        raise typer.Exit(1)
...
def benchmark_models(
    ...
    console.print("  📊 Utilisez 'mptoo models info' pour plus de détails sur chaque modèle")
    console.print("  🎮 Optimisez les performances avec 'mptoo agents gpu-optimize'")
