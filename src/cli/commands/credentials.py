...
def add(
    ...
    Examples:
        ...
        mptoo credentials add github --url https://github.com --username myuser

        # Add API key
        mptoo credentials add openai --url https://api.openai.com --type api_key
    """
...
def list_credentials(
    ...
    Examples:
        ...
        mptoo credentials list

        # List only dev-related credentials
        mptoo credentials list --tag dev
    """
    try:
        manager = get_credential_manager()
    except Exception as e:
...
def show(
    ...
    Examples:
        mptoo credentials show github
        mptoo credentials show github --show-password
    """
    manager = get_credential_manager()
    cred = manager.get_credential(site_name)
...
def remove(
    ...
    Examples:
        mptoo credentials remove github
        mptoo credentials remove github --yes
    """
    manager = get_credential_manager()
...
def export(
    ...
    Examples:
        ...
        mptoo credentials export --output backup.json

        # Export with passwords (dangerous!)
        mptoo credentials export --output backup.json --include-passwords
    """
...
def import_creds(
    ...
    Examples:
        # Merge with existing
        mptoo credentials import backup.json

        # Replace all existing credentials
        mptoo credentials import backup.json --replace
    """
