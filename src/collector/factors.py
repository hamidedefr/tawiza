"""
Territorial Alpha Factors Calculator - Phase 2 Algorithm MPtoO-V2 (Version Corrigée)
...
class PostgreSQLDataCollector:
    ...
    def __init__(self):
        self.conn_params = {
            'host': 'localhost',
            'port': 5433,
            'database': os.getenv("SIGNALS_DB_NAME", "mptoo_signals"),
            'user': os.getenv("DATABASE_USER", "mptoo"),
