...
def register_dashboard_tools(mcp: FastMCP) -> None:
    ...
    @mcp.tool()
    async def mptoo_dashboard_status(ctx: Context = None) -> str:
        """Récupère le status global du dashboard MPtoO.
...
<table><tr><th>Nom</th><th>SIRET</th><th>Source</th><th>Ville</th></tr>"""
                ...
                html += """</table>
<p style="margin-top: 40px; color: #666;">Généré par MPtoO Dashboard</p>
</body></html>"""
