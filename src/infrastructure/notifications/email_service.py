...
class EmailConfig:
    ...
    use_tls: bool = True
    from_email: str = "noreply@mptoo.local"
    from_name: str = "MPtoO Notifications"
...
class EmailService:
    ...
    def _load_config_from_env(self) -> EmailConfig:
        ...
        return EmailConfig(
            ...
            from_email=os.getenv("SMTP_FROM_EMAIL", "noreply@mptoo.local"),
            from_name=os.getenv("SMTP_FROM_NAME", "MPtoO Notifications"),
        )
    ...
    async def send_analysis_notification(
        ...
        Returns:
            Send result
        """
        subject = f"[MPtoO] Analyse terminée: {analysis_name}"
...
"""
        ...
        body += "\n--\nMPtoO - Intelligence Territoriale"
