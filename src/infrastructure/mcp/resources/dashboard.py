...
- mptoo://dashboard/status - System status
- mptoo://dashboard/alerts - Unread alerts
- mptoo://dashboard/history - Recent analyses
- mptoo://dashboard/stats - Usage statistics
"""
...
def register_dashboard_resources(mcp: FastMCP) -> None:
    ...
    @mcp.resource("mptoo://dashboard/status")
    ...
    @mcp.resource("mptoo://dashboard/alerts")
    ...
    @mcp.resource("mptoo://dashboard/history")
    ...
    @mcp.resource("mptoo://dashboard/stats")
