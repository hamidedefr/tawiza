...
class TestAgentOrchestrator:
    ...
    def test_initialization(self):
        ...
        # Check MPtoO agents
        assert len(orch.mptoo_agents) == 9
        assert "mptoo-analyst" in orch.mptoo_agents
    ...
    def test_is_mptoo_agent(self):
        """Test MPtoO agent detection."""
        orch = AgentOrchestrator()

        assert orch.is_mptoo_agent("mptoo-analyst") is True
        assert orch.is_mptoo_agent("mptoo-data") is True
        assert orch.is_mptoo_agent("general") is False
        assert orch.is_mptoo_agent("qwen3:14b") is False
