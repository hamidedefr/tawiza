...
class LogReader:
    ...
    # Log file sources
    LOG_SOURCES = {
        "mptoo": Path("/root/MPtoO-V2/logs/advanced_debug.log"),
    ...
    PATTERNS = {
        # MPtoO format: 2025-11-21 12:01:43,832 | INFO | module | message | func:line
        "mptoo": re.compile(
    ...
    def parse_line(self, line: str, source_type: str = "mptoo") -> LogEntry | None:
        ...
        # Try MPtoO format
        match = self.PATTERNS["mptoo"].match(line)
        if match:
