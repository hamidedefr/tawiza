#!/usr/bin/env python3
"""
Module de gestion d'erreurs pour MPtoO-V2 CLI
...
class MPtoOError(Exception):
    """Exception de base pour MPtoO-V2"""
...
class ConfigNotFoundError(ConfigError):
    ...
    def __init__(self, path: str):
        super().__init__(
            ...
            suggestions=["Exécutez 'mptoo system init' pour créer la configuration"]
        )


# System errors
class SystemError(MPtoOError):
    """Erreur système"""
    pass
...
class SystemNotInitializedError(SystemError):
    ...
    def __init__(self):
        super().__init__(
            ...
            suggestions=["Exécutez 'mptoo system init' d'abord"]
        )
...
class AgentNotFoundError(AgentError):
    ...
    def __init__(self, agent_name: str):
        super().__init__(
            ...
            suggestions=["Listez les agents disponibles avec 'mptoo agents list'"]
        )


# File errors
class FileError(MPtoOError):
    """Erreur de fichier"""
    pass
...
class ErrorHandler:
    ...
    def handle(
        ...
        if isinstance(error, ErrorInfo):
            info = error
        elif isinstance(error, MPtoOError):
            info = error.info
        else:
            info = ErrorInfo(
    ...
    def decorator(func: F) -> F:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            try:
                ...
                if reraise:
                    raise
                error = MPtoOError(str(e), code=default_code)
