"""Prompt management commands for MPtoO CLI."""
...
def list_templates(
    ...
    Examples:
        ...
        mptoo prompts list --format browser
    """
    try:
        params = {}
        if format_filter:
...
def show_template(
    ...
    Examples:
        mptoo prompts show browser_navigation
    """
    try:
...
def render_template(
    ...
    Examples:
        ...
        mptoo prompts render browser_navigation \\
            --var url=google.com \\
            --var action="search for Python"

        # Render classification template
        mptoo prompts render text_classification \\
...
def delete_template(
    ...
    Examples:
        mptoo prompts delete my_template
        mptoo prompts delete my_template --force
    """
    try:
        if not force:
