...
# Telegram config (reuses alert-bridge bot)
TELEGRAM_BOT_TOKEN = os.getenv(
    "TELEGRAM_BOT_TOKEN", "8464676923:AAGLv7gkBhXVxvC4OMoWTd7F4eIGiwkj9tc"
)
TELEGRAM_CHAT_ID = os.getenv("TELEGRAM_CHAT_ID", "1158974656")
