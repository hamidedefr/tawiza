...
def get_repo() -> SignalRepository:
    ...
    if _repo is None:
        db_url = os.getenv(
            ...
            "postgresql+asyncpg://mptoo:changeme@localhost:5433/mptoo",
        )
...
async def get_ml_anomalies(
    ...
    try:
        ...
        return {
            ...
            "algorithm": "MPtoO-V2 Phase 4 - ML Detection"
        }
...
async def get_ml_clusters(
    ...
    try:
        ...
        return {
            ...
            "algorithm": f"MPtoO-V2 Phase 4 - {method.upper()} Clustering"
        }
...
async def get_discovered_factors(
    ...
    try:
        ...
        return {
            ...
            "algorithm": "MPtoO-V2 Phase 4 - LLM Factor Mining",
...
async def trigger_ml_detection(
    ...
    try:
        ...
        return {
            ...
            "algorithm": "MPtoO-V2 Phase 4 - ML Detection Suite"
        }
...
async def compute_alpha_features(
    ...
    try:
        ...
        config = DataHandlerConfig(
            db_url=os.getenv(
                "COLLECTOR_DATABASE_URL",
                "postgresql://mptoo:changeme@localhost:5433/mptoo"
            ),
