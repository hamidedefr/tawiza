...
class ErrorHandlerMiddleware(BaseHTTPMiddleware):
    ...
    def _error_response(self, error: MPtoOError) -> JSONResponse:
...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    @app.exception_handler(MPtoOError)
    async def mptoo_error_handler(request: Request, exc: MPtoOError):
        request_id = get_request_id()
    ...
    async def http_error_handler(request: Request, exc: HTTPException):
        ...
        return JSONResponse(
            ...
            content={
                "success": False,
                "error": {
                    "code": f"MPTOO-API-{exc.status_code}",
                    "message": exc.detail,
                    "details": {},
                },
                "request_id": request_id,
