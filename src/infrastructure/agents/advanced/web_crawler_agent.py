#!/usr/bin/env python3
"""
WebCrawlerAgent - Agent spécialisé dans le crawling web intelligent pour MPtoO-V2
...
class CrawlConfig:
    ...
    user_agent: str = "MPtoO-Crawler/1.0 (+https://mptoo.ai/bot)"
            ...
            if response.status_code == 200:
                ...
                for line in content.split("\n"):
                    ...
                    if line.startswith("user-agent:"):
                        ...
                        current_agent = agent == "*" or "mptoo" in agent
