"""Browser automation commands for MPtoO CLI using OpenManus."""
...
def run(
    ...
    Examples:
        ...
        mptoo browser run "Go to news.ycombinator.com and get top 5 articles"

        # Start from specific URL
        mptoo browser run "Find the pricing page" --url https://example.com

        # Fill a form
        mptoo browser run "Fill the contact form with name John and email john@test.com" --url https://example.com/contact
    """
    try:
        with Progress(
            SpinnerColumn(),
...
def extract(
    ...
    Examples:
        mptoo browser extract https://news.ycombinator.com "top 10 article titles"
        mptoo browser extract https://example.com "all product prices" --selector ".price"
    """
    try:
...
def fill_form(
    ...
    Example:
        mptoo browser fill-form https://example.com/contact '{"name":"John","email":"john@test.com"}' --submit
    """
    try:
        import json
...
def click(
    ...
    Example:
        mptoo browser click https://example.com "#submit-button"
    """
    try:
