"""Advanced agents commands for MPtoO CLI v2 pro.
...
def register(app: typer.Typer) -> None:
    ...
    def list_agents(
        ...
        console.print(table)
        console.print()
        console.print("  [dim]Run an agent:[/] mptoo pro agent-run <name> --task <task>")
    ...
    def debug_agent(
        ...
        if task_id:
            ...
            tasks_file = Path.home() / ".mptoo" / "agent_tasks.json"
            ...
            console.print()
            console.print("  [dim]View task details:[/] mptoo pro agent-debug <task-id>")
    ...
    def configure_agent(
        ...
        config_file = Path.home() / ".mptoo" / "agent_config.json"
